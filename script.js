...
function displayGames(gameList, games) {
    ...
    if (publicGames.length === 0) {
        ...
        // отфильтруем игры для текущего пользователя
        ...
        publicGames.forEach((game, index) => {
              const gameItem = document.createElement('div');
                ...
                let deleteButton = '';
                if (currentUser && (game.uploader === currentUser.username || game.uploader === currentUser.email) ) {
